...
public class AUDpaneb {
	...
	public JPanel create() {
		...
		MaskFormatter maskDuracao = null;
		
		try {
			maskData = new MaskFormatter("####-##-##");
			maskHora = new MaskFormatter("##:##:##");
			maskDuracao = new MaskFormatter("##:##:##");
		...
		maskDuracao.setPlaceholderCharacter('0');
		...
		fieldDuracao = new JFormattedTextField(maskDuracao);
		fieldData = new JFormattedTextField(maskData);
		fieldHora = new JFormattedTextField(maskHora);
		
		botaoUpdate= new JButton("Alterar Atendimento");
		botaoDelete = new JButton("Excluir Atendimento");
